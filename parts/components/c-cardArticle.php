<div class="c-cardArticle <?php echo $cCardArticle["extraClass"] ?>">
    <div class="c-cardArticle__category">
        <a href="noticias" class="c-tagCategory"><span>Polícia</span></a>
    </div>
    <a href="noticia-open" class="c-cardArticle__figure">
    ...
    <div class="c-cardArticle__content">
        <div class="c-cardArticle__infos">
            <div class="c-cardArticle__infos__user">
                <a href="colunista-open">Por Jairo Silva</a>
            </div>
            <div class="c-cardArticle__infos__date">
                <a href="noticia-open">23/05/2022 - 13H55</a>
            </div>
        </div>
        <a href="noticia-open" class="c-cardArticle__title">
            <h2>Carnês do IPTU de Maracajá já estão sendo entregues nas residências</h2>
        </a>
    </div>
</div>
